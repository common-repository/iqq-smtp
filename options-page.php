...
<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<?php settings_fields( 'iqq-smtp-settings-group' ); ?>
		<?php do_settings_sections( 'iqq-smtp-settings-group' ); ?>
		...
		<table class="form-table">
			...
			<tr>
				...
				<td><input type="checkbox" name="iqq-smtp-active" id="iqq-smtp-active"
						<?php checked( get_option( 'iqq-smtp-active' ) ) ?>
			...
			<tr>
				...
				<td><input type="text" name="iqq-smtp-host" id="iqq-smtp-host"
				           value="<?php echo get_option( 'iqq-smtp-host' ); ?>"
			...
			<tr>
				...
				<td><input type="number" name="iqq-smtp-port" id="iqq-smtp-port"
				           value="<?php echo esc_attr( get_option( 'iqq-smtp-port' ) ); ?>"
				           required <?php echo $disabled ?>/></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="iqq-smtp-username" id="iqq-smtp-username"
				           value="<?php echo esc_attr( get_option( 'iqq-smtp-username' ) ); ?>"
				           required <?php echo $disabled ?>/></td>
			</tr>
			<tr>
				...
				<td><input type="password" name="iqq-smtp-password" id="iqq-smtp-password"
				           value="<?php echo esc_attr( get_option( 'iqq-smtp-password' ) ); ?>"
				           required <?php echo $disabled ?>/></td>
			</tr>
			</tbody>
		</table>
		...
		<table class="form-table">
			...
			<tr>
				...
				<td><input type="text" name="iqq-smtp-sender" id="iqq-smtp-sender"
				           value="<?php echo esc_attr( get_option( 'iqq-smtp-sender' ) ); ?>"
				           required <?php echo $disabled ?>/></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="iqq-smtp-sendermail" id="iqq-smtp-sendermail"
				           value="<?php echo esc_attr( get_option( 'iqq-smtp-sendermail' ) ); ?>"
				           required <?php echo $disabled ?>/></td>
			</tr>
			</tbody>
		</table>
